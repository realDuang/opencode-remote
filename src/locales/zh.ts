...
export const zh: LocaleDict = {
  ...
  worktree: {
    ...
    workingMode: "工作模式",
    normalMode: "普通模式",
    normalModeDesc: "直接在主仓库中工作",
    isolatedMode: "隔离模式",
    isolatedModeDesc: "创建独立的工作树和分支",
    branchName: "分支名称",
    ...
    abandoning: "放弃中...",
    mergeTitle: "合并更改",
    mergeDesc: "将此隔离会话的所有更改压缩合并到基础分支",
    commitMessage: "提交信息",
    commitMessagePlaceholder: "描述要合并的更改",
    deleteWorktree: "合并后删除工作树",
    deleteBranch: "合并后删除分支",
    pushTitle: "推送到远程",
    pushDesc: "将更改推送到远程仓库。推送前可以重命名分支。",
    newBranchName: "远程分支名称",
    newBranchNamePlaceholder: "例如：feature/my-feature",
    abandonTitle: "放弃更改",
    abandonDesc: "丢弃所有更改并删除此隔离会话",
    abandonWarning: "此操作无法撤销。所有未提交的更改将会丢失。",
    uncommittedWarning: "您有未提交的更改",
